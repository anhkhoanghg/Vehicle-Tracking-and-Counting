...
def count_vehicle(box_id, img):
    ...
    if (iy > middle_line_position - 15) and (iy < middle_line_position):
        if id not in temp_up_list:
            temp_up_list.append(id)
    elif (iy < middle_line_position + 15) and (iy > middle_line_position):
        if id not in temp_down_list:
            temp_down_list.append(id)       
    elif iy < middle_line_position - 15:
